		...
		<div class="panel">
			<div class="panel-body">
				...
				<form class="form-horizontal forms" id="forms">
					...
					<div class="form-group">
						<label class="col-lg-2"><?php echo Yii::t("default","Citypay Password")?></label>
						<div class="col-lg-6">
							<?php 
					...
					<div class="form-group">
						<label class="col-lg-2"><?php echo Yii::t("default","Citypay Signature")?></label>
						<div class="col-lg-6">
							<?php 
							echo CHtml::textField('admin_sanbox_citypay_signature',
							Yii::app()->functions->getOptionAdmin('admin_sanbox_citypay_signature')
							,array(
							'class'=>"form-control"
							))
							?>
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							<?php 
							echo CHtml::textField('admin_live_citypay_user',
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							<?php 
							echo CHtml::textField('admin_live_citypay_signature',
							Yii::app()->functions->getOptionAdmin('admin_live_citypay_signature')
							,array(
							'class'=>"form-control"
							))
							?>
