	...
	<div class="col-sm-12">
		<div class="panel table-responsive">
			...
			<div class="panel-body">
				<h4 class="mt-0 header-title"><b><?php echo Yii::t("default","Background Image List")?></b></h4>
				<form id="frm_table_list" method="POST" >
					<input type="hidden" name="action" id="action" value="bgimageList">
					<input type="hidden" name="tbl" id="tbl" value="bground_img">
					<input type="hidden" name="clear_tbl"  id="clear_tbl" value="clear_tbl">
                                        <input type="hidden" name="whereid"  id="whereid" value="id">
                                        <input type="hidden" name="slug" id="slug" value="background_image">
					<table id="table_list" class="table table-striped table-bordered">
						<thead>
							<tr>
								<tr>								 
								<th><?php echo Yii::t("default","Image")?></th>
                                                                <th><?php echo Yii::t("default","Image Alt")?></th>
