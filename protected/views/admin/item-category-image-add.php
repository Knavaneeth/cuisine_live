		...
		<div class="panel">
			<div class="panel-heading">
				<div class="merchant-btns">
					<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/ItemCategoryImage/Do/Add" class="btn btn-default"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Add New")?></a>
					<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/ItemCategoryImage" class="btn btn-default"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
				</div>
			</div>
			<div class="panel-body">
				...
				<form class="form-horizontal forms" id="forms">
                    ...
                    <div class="form-group">
						<label class="col-lg-2"><?php echo Yii::t("default","Tooltip Text")?></label>
						<div class="col-lg-6">
							<?php 
							echo CHtml::textField('tooltip_text',
                                                        isset($data['tooltip_text'])?$data['tooltip_text']:""						 
							,array('class'=>"form-control",'data-validation'=>"required"))
							?>
						</div>
					</div>   
