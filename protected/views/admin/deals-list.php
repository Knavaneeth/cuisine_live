		...
		<div class="panel table-responsive">
			<div class="panel-heading">
				...
				<!--	<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/deals?Do=Add" class="btn btn-default"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Add New")?></a>				-->	
					<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/deals" class="btn btn-default"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
			...
			<div class="panel-body">
				<h4 class="mt-0 header-title"><b><?php echo Yii::t("default","Deals Merchant List")?></b></h4>
				<form id="frm_table_list" method="POST" >
					<input type="hidden" name="action" id="action" value="admin_merchant_list">
					<input type="hidden" name="tbl" id="tbl" value="option">
