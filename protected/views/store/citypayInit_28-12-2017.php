...
if ( $data=Yii::app()->functions->getOrder($_GET['id'])){     
 ...
 /*    $subcat_list = Yii::app()->functions->getAddOnLists($merchant_id);                            
    ...
    $details = array(
        ...
        {
            $discount_amount = $data['deals_discount_amt'];
        }
   ...
   $total_amount = $data['sub_total']+$data['delivery_charge']+$data['taxable_total']+$data['packaging']+$data['cart_tip_value']-$discount_amount;  
