...
if(!$paypal_mode=Yii::app()->functions->getOption('paypal_mode',$merchant_id))
{
	$paypal_mode = "sandbox";
}
else
...
<div class="uk-form-row">
	<label class="uk-form-label"><?php echo Yii::t("default","paypal_mode")?></label>
		<div class="col-lg-6">
			<?php  
			$chk_box1_sts = true;
			$chk_box2_sts = false;
			...
			echo "<label> sandbox </label>";
			echo "&emsp;";
			echo CHtml::radioButton('paypal_mode', $chk_box1_sts , array(
			'value'=>'sandbox',
			'name'=>'btnname',
			'uncheckValue'=>null
			));
			...
			echo "&emsp;";
			echo CHtml::radioButton('paypal_mode', $chk_box2_sts, array(
			    'value'=>'live',
			    'name'=>'btnname',
			    'uncheckValue'=>null
			)); 
...
<div class="uk-form-row">
	<label class="uk-form-label"><?php echo Yii::t("default","paypal_mode")?></label>
		<div class="col-lg-6">
			...
			$chk_box1_sts = true;
			$chk_box2_sts = false;
			$mobile_paypal_mode = getOption($merchant_id,'mt_paypal_mobile_mode');
			if(($mobile_paypal_mode)=="live"):
			$chk_box1_sts = false;
			$chk_box2_sts = true;
			endif;
			echo "<label> sandbox </label>";
			echo "&emsp;";
			echo CHtml::radioButton('mt_paypal_mobile_mode', $chk_box1_sts , array(
			'value'=>'sandbox',
			'name'=>'btnname',
			'uncheckValue'=>null
			));
			...
			echo "<label> live </label>";
			echo "&emsp;";
			echo CHtml::radioButton('mt_paypal_mobile_mode', $chk_box2_sts, array(
			    'value'=>'live',
			    'name'=>'btnname',
			    'uncheckValue'=>null
			)); 
