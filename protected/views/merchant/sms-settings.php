...
<div class="uk-form-row">
  <label class="uk-form-label">
  <?php echo Yii::t("default","SMS Notification Message When Merchant Declined Table Booking")?>  
  <p class="uk-text-small">(<?php echo t("leave empty to if you don't want to send sms")?>)</p>
  </label>
  <?php 
  echo CHtml::textArea('sms_alert_tbl_rej',
  Yii::app()->functions->getOption("sms_alert_tbl_rej",$merchant_id)
  ,array(
    'class'=>"uk-form-width-large",
    'style'=>"height:150px"
  ))
...
<ul style="margin:0;padding:0;">
  <?php echo Yii::t("default","Available Tags")?>:
  <li style="list-style:none;" class="uk-text-muted"><?php echo t("{customer-name} = Customer name")?></li>
  <li style="list-style:none;" class="uk-text-muted"><?php echo t("{booking-date} = Booking date")?></li>
  <li style="list-style:none;" class="uk-text-muted"><?php echo t("{booking-time} = Booking date")?></li></ul>
  <li style="list-style:none;" class="uk-text-muted"><?php echo t("{no-of-person} = No of person")?></li>
</ul>
...
<div class="uk-form-row">
  <label class="uk-form-label">
  <?php echo Yii::t("default","SMS Notification Message When Merchant Accept Table Booking")?>  
  <p class="uk-text-small">(<?php echo t("leave empty to if you don't want to send sms")?>)</p>
  </label>
  <?php 
  echo CHtml::textArea('sms_alert_tbl_accept',
  Yii::app()->functions->getOption("sms_alert_tbl_accept",$merchant_id)
  ,array(
    'class'=>"uk-form-width-large",
    'style'=>"height:150px"
  ))
