...
<?php echo CHtml::hiddenField('action','addSubcategory')?> 
<?php echo CHtml::hiddenField('id',isset($_GET['id'])?$_GET['id']:"");?>
<?php if (!isset($_GET['id'])):?>
<?php echo CHtml::hiddenField("redirect",Yii::app()->request->baseUrl."/merchant/subCategoryList/Do/Add")?>
<?php endif;?>

<?php 
if (isset($_GET['id'])){
	if (!$data=Yii::app()->functions->get_subcategory_details($_GET['id'])){
...
<ul class="uk-switcher" id="tab-content">
  ...
  <li class="uk-active">      
  <div class="uk-form-row">
   <label class="uk-form-label"><?php echo Yii::t("default","Food Subcategory Name")?></label>
...
<label class="uk-form-label"><?php echo Yii::t("default","Food Subcategory Name")?></label>
  ...
  isset($data['sub_category_name'])?stripslashes($data['sub_category_name']):""
  ,array(
  'class'=>'uk-form-width-large',
  'data-validation'=>"required"
  ))?>  
...
<label class="uk-form-label"><?php echo Yii::t("default","Food Subcategory Name")?></label>
  ...
  CHtml::textArea('subcategory_desc',isset($data['sub_category_desc'])?stripslashes($data['sub_category_desc']):"", array(
    'rows' => 6, 'cols' => 50, 'class'=>'uk-form-width-large'))
 ?>  
</div>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo t("Category Name")?></label>
  <?php echo CHtml::dropDownList('category_name',
  isset($data['cat_id'])?$data['cat_id']:"",
  Yii::app()->functions->get_merchant_category(Yii::app()->functions->getMerchantID()),          
  array(
  'class'=>'uk-form-width-large',
  'data-validation'=>"required"
  ))?>
