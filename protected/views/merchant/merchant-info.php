			...
			<?php echo CHtml::hiddenField('country_code',isset($data['country_code'])?$data['country_code']:"")?>
				<ul class="uk-switcher uk-margin " id="tab-content">
					<li class="uk-active">
						<fieldset>        
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Restaurant Slug")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Restaurant name")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","ABN")?></label>
								<div class="col-lg-6">
							...
							<?php endif;?>
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Restaurant phone")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Contact name")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Contact phone")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Contact email")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Country")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Country code")?></label>
								<div class="col-lg-6">
									<?php echo isset($data['country_code'])?$data['country_code']:""?>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Street address")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","City")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Parish")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Post code")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","State/Region")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Cuisine")?></label>
								<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-lg-2"><?php echo Yii::t("default","Collection or Delivery?")?></label>
								<div class="col-lg-6">
				...
				<li>
					...
					<li>
						...
						?>
						<div class="form-group">
							<label class="col-lg-2"><?php echo Yii::t("default","Latitude")?></label>
							<div class="col-lg-6">
						...
						<div class="form-group">
							<label class="col-lg-2"><?php echo Yii::t("default","Longitude")?></label>
							<div class="col-lg-6">
