...
$merchant_pickup_estimation = Yii::app()->functions->getOption("merchant_pickup_estimation",$merchant_id); 
...
<!--<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Merchant Logo")?></label>
    <div style="display:inline-table;margin-left:1px;" class="upload_image_btn" id=""><?php echo Yii::t('default',"Browse")?></div>	     
</div>-->

<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Merchant Logo")?></label>
  <div style="display:inline-table;margin-left:1px;" class="button uk-button" id="img_upload"><?php echo Yii::t('default',"Browse")?></div>	  
...
<?php 
  ...
  'placeholder'=>Yii::t("default","Enter only number in minutes"),
  "class"=>"numeric_only merchant_delivery_estimation",
  "identity"=>"delivery"
  ));
  ?>
  <span id="delivery_estimation_in_hrs_mins"><?php echo Yii::app()->functions->convertToHoursMins($merchant_delivery_estimation,'%02d hrs %02d min'); ?></span>
</div>

<div class="uk-form-row">
<label class="uk-form-label"><?php echo Yii::t("default","Pickup Estimation")?></label>
<?php 
  echo CHtml::textField('merchant_pickup_estimation',$merchant_pickup_estimation,array(
  'placeholder'=>Yii::t("default","Enter only number in minutes"),
  "class"=>"numeric_only merchant_pickup_estimation",
  "identity"=>"pickup"
  ));
  ?>
  <span id="pickup_estimation_in_hrs_mins"><?php echo Yii::app()->functions->convertToHoursMins($merchant_pickup_estimation,'%02d hrs %02d min'); ?></span>
</div>
...
?>
   ...
   <?php
      $chk_box1_sts = true;
      $chk_box2_sts = false;
      $url_terms_condition_div = 'style="display:block;"';
      $txtbox_terms_condition_div = 'style="display:none;"';
      $merchant_slt_terms_type = Yii::app()->functions->getOption("merchant_slt_terms_type",$merchant_id);
      if($merchant_slt_terms_type==1)
      {
          $chk_box1_sts = false;
          $chk_box2_sts = true;
          $url_terms_condition_div = 'style="display:none;"';
          $txtbox_terms_condition_div = 'style="display:block;"';
      }
    ?> 

    <div class="uk-form-row">
      <label class="uk-form-label"><?php echo Yii::t("default"," Primary IP")?></label>
      <?php 
      echo CHtml::textField('primary_ip',
      Yii::app()->functions->getOption("primary_ip",$merchant_id)
      ,array(
      'placeholder'=>"" 
      ));
      ?>
    ...
    <div class="uk-form-row">
      <label class="uk-form-label"><?php echo Yii::t("default"," Kitchen IP")?></label>
      <?php 
      echo CHtml::textField('kitchen_ip',
      Yii::app()->functions->getOption("kitchen_ip",$merchant_id)
      ,array(
      'placeholder'=>"" 
      ));
      ?>
    ...
    <div class="uk-form-row">
      <label class="uk-form-label"><?php echo Yii::t("default"," Select Terms Type")?></label>
      <?php     
      echo "<label> Enter URL of Terms & Condition page </label>";
      echo "&emsp;";
      echo CHtml::radioButton('slt_terms_type', $chk_box1_sts , array(
      'value'=>'0',
      'name'=>'terms_type',
      'class'=>'terms_type',
      'uncheckValue'=>null
      ...
      echo "&emsp;";
      echo "<label> New content for Terms & Condition </label>";
      echo "&emsp;";
      echo CHtml::radioButton('slt_terms_type', $chk_box2_sts, array(
        'value'=>'1',
        'name'=>'terms_type',
        'class'=>'terms_type',
        'uncheckValue'=>null
...
<div class="uk-form-row" id="url_terms_condition" <?php echo $url_terms_condition_div; ?>>
<label class="uk-form-label"><?php echo Yii::t("default","Enter URL ")?></label>
<?php 
echo CHtml::textArea('merchant_terms_conditions_url',
Yii::app()->functions->getOption("merchant_terms_conditions_url",$merchant_id)
,array(
'class'=>"uk-form-width-large"
));
?>
...
<div class="uk-form-row" id="txtbox_terms_condition" <?php echo $txtbox_terms_condition_div; ?> >
<label class="uk-form-label"><?php echo Yii::t("default","Terms & Conditions")?></label>
<?php 
echo CHtml::textArea('merchant_terms_conditions',
Yii::app()->functions->getOption("merchant_terms_conditions",$merchant_id)
,array(
    ...
    <div class="modal-content">   
      <div class="modal-header">
        ...
        <h4 class="modal-title">Upload Image</h4>
                <span id="image_size" > Please Upload a Image of size 500*338 </span>
      </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">   
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Upload Image</h4>
                <span id="image_size" > Please Upload a Image of size 400*240 </span>
