...
$instagram_page=Yii::app()->functions->getOption("instagram_page",$merchant_id);
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Instagram Page")?></label>
  <?php   
  echo CHtml::textField('instagram_page',$instagram_page,array(
       'class'=>'uk-form-width-large',
  ))
  ?>
</div>
