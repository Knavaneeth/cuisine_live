...
class pagination {
	...
	public $infinite_class          = 'infinite-more-link';
	...
	public function render() {
		...
		if($this->steps	===	true && $this->currentpage > 1) {
			echo '<li class="prev"><a href="'.$this->render_text($this->link_url,($this->currentpage-1)).'" title="'.$this->render_text($this->steps_back_title,($this->currentpage-1)).'">'.$this->render_text($this->steps_back_text,($this->currentpage-1)).'</a></li>' . PHP_EOL;
		}
		...
		if($this->steps	===	true && $this->currentpage < $this->totalpages) {
			echo '<li class="next"><a class="" href="'.$this->render_text($this->link_url,($this->currentpage+1)).'" title="'.$this->render_text($this->steps_next_title,($this->currentpage+1)).'">'.$this->render_text($this->steps_next_text,($this->currentpage+1)).'</a></li>' . PHP_EOL;
		}
