...
class AdminController extends CController
{
	...
	public function actionCitypaySettings()
	{
		$this->crumbsTitle=Yii::t("default","Citypay Settings");
		$this->render('citypay-settings');
	}
	public function actionChippinpaySettings()
	{
		$this->crumbsTitle=Yii::t("default","Chippinpay Settings");
		$this->render('chip_pin-settings');
	}
	...
	public function actionMerchant()
	{
	 ...
	 public function actionBackground_image()
	{
            if (isset($_GET['Do']))
                {
                if ($_GET['Do']=="Add")
			   ...
			   $this->crumbsTitle=Yii::t("default","Add Background Image");
                ...
                {
                            $this->crumbsTitle=Yii::t("default","Background Image");
                            $this->render('bground-img-list');		     
		}       	
	}

		 public function actionExport_json()
	{
            if (isset($_GET['Do']))
                {
                if ($_GET['Do']=="Add")
                    {
			   $this->crumbsTitle=Yii::t("default","Add External Json");
                           $this->render('external-json-add');
                    } 
                    else 
                    {
	   	   	   $this->crumbsTitle=Yii::t("default","Background Image Sort");
                ...
                {
                            $this->crumbsTitle=Yii::t("default","Export Json");
                            $this->render('export-json-list');		     
		}       	
	}	
		 ...
		 public function actionDeals()
	{
            if (isset($_GET['Do']))
                ...
                if ($_GET['Do']=="Add")
                    {
			   $this->crumbsTitle=Yii::t("default","  Merchant List  ");
	...
	public function actionsetNewtableBookingtime()
	{
		echo "Hello";
		 ...
		 public function actionParish()
	{
            if (isset($_GET['Do']))
                {
                if ($_GET['Do']=="Add")
                    {
			   			   $this->crumbsTitle=Yii::t("default","  Parish ");
                           $this->render('parish_add');
                    }             
				} 
                else 
                {
                            $this->crumbsTitle=Yii::t("default"," Parish ");
                            $this->render('parish_list');		     
		}       	
	}  
	 ...
	 public function actionItemCategoryImage()
	{
        ...
        public function actionAdd_bg_image()
	{
		$this->crumbsTitle=Yii::t("default","Add Background Image");
		$this->render('bgimage-add');
	}
