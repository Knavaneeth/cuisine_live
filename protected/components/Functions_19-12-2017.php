...
{	
	...
	public function get_driver_collection_list($merchant_id='',$date='')
	{
		...
		$exception_query = "
		SELECT mt_delivery_boys.driver_name,mt_order.total_w_tax,mt_order.payment_type,mt_order_delivery_address.state,mt_driver_task.delivery_time,mt_order.order_id FROM	`mt_driver_task`
	...
	public function merchantMenu()
	{
		...
		return array(  
		    ...
		    'items'=>array(
                ...
                array('visible'=>$this->hasMerchantAccess("deliveryboys"),'tag'=>"deliveryboys",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Delivery Drivers"),
                ...
                array('visible'=>$this->hasMerchantAccess("SubCategoryList"),'tag'=>"SubcategoryList",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Food SubCategory"),
