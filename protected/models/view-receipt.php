...
" ".$merchant_info['post_code'];
	    ...
	    <div class="receipt-main-wrap">		   
		   ...
		   <?php  
	    			...
	    			{
	    					$DbExt=new DbExt;
	    					$client_query = "SELECT `client_name` FROM `mt_guest_details` WHERE `order_id` = ".$order_id;
	    					if($client_name = $DbExt->rst($client_query))
	    					{
	    						$data['full_name'] = isset($client_name[0]['client_name'])?$client_name[0]['client_name']:'';
	    					}
	    			}
	       ...
	       <div class="input-block">
	         ...
	         <div class="value"><?php echo stripcslashes($data['merchant_name'])?></div>
	         <div class="clear"></div>
	       </div>
