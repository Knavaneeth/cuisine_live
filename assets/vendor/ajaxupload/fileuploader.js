...
qq.FileUploader = function(o)
{
    ...
    qq.extend(this._options,
    {
        element: null,
        listElement: null,
        template: '<div class="qq-uploader">' + '<div class="qq-upload-drop-area"><span>Drop files here to upload</span></div>' + '<div class="qq-upload-button">' + js_lang.trans_21 + '</div>' + '<ul class="qq-upload-list"></ul>' + '</div>',
